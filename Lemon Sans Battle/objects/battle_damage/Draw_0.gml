...
if(damage<=0){
	...
	case 2:
	draw_sprite_ext(spr_battle_damage_clash,0,xstart,y,1,1,0,c_gray,1);
	break;
	
	case 3:
	draw_sprite_ext(spr_battle_damage_yeet,0,xstart,y,1,1,0,c_gray,1);
	break;
	
	case 4:
	draw_sprite_ext(spr_battle_damage_yoink,0,xstart,y,1,1,0,c_gray,1);
	break;
	
	case 5:
	draw_sprite_ext(spr_battle_damage_vore,0,xstart,y,1,1,0,c_gray,1);
	break;
	
	case 6:
	draw_sprite_ext(spr_battle_damage_absorb,0,xstart,y,1,1,0,c_gray,1);
	break;
	}
}