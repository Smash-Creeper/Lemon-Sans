...
if(phase=0){
//draw_self()
draw_sprite_ext(spr_pixel_2,0,x,y,1,650*scale,image_angle,choose(c_red,c_yellow),1)
}else
if(phase=1){
	...
	draw_sprite_ext(spr_pixel_2,0,x,y,image_xscale,image_yscale,image_angle,c_yellow,image_alpha)
}