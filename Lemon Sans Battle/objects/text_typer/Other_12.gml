...
switch(cmd[|0]){
	...
	case "dialog_visible":
		if(is_real(cmd[|1])){
			...
			battle_dialog_enemy.visible=cmd[|1];
			}
		}
		break;
	...
	case "sans_state":
		if(is_real(cmd[|1])){
			...
			battle_enemy_sans.state=cmd[|1];
			}
		}
		break;
		
	case "papyrus_emotion":
		if(is_real(cmd[|1])){
			if(instance_exists(battle_enemy_sans)){
			battle_enemy_sans._papyrus_expression=cmd[|1];
			}
		}
		break;
	...
	case "_egg_frame":
		if(is_real(cmd[|1])){
			if(instance_exists(battle_enemy_sans)){
			battle_enemy_sans._egg_frame=cmd[|1];
			}
		}
		break;
	...
	case "epic_fader":
		...
		//	if(instance_exists(battle_enemy_sans)){
			fader.color=c_white;
			Anim_Create(fader,"alpha",0,0,fader.alpha,1,1/0.005)
		//	}
		//}
		break;
	case "epic_fader_fast":
		//if(is_real(cmd[|1])){
		//	if(instance_exists(battle_enemy_sans)){
			fader.color=c_white;
			Anim_Create(fader,"alpha",0,0,fader.alpha,1,1/0.020)
		//	}
		//}
		break;
	case "epic_unfader":
